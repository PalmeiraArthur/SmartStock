...
function Footer() {
    ...
    return (
        <div className="flex items-center justify-center bg-verde-smartStock fixed left-0 bottom-0 w-screen h-[75px] z-10 gap-[600px]">
            <button
                onClick={() => navigate('/home')}
                className="flex flex-col items-center justify-center h-[45px] w-[45px] text-white text-center"
            >
